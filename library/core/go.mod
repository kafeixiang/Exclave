...
require github.com/dyhkwong/libsagernetcore v0.0.0-20260331002808-d61c0f23dfa4
...
replace (
	github.com/v2fly/v2ray-core/v5 => github.com/dyhkwong/v2ray-core/v5 v5.48.1-0.20260331002652-e216f11da653
