...
require github.com/exclavenetwork/libexclavecore v0.0.0-20260829141405-321c2fe0e958
...
require (
	...
	github.com/exclavenetwork/exclave-core/v5 v5.50.1-0.20260829140238-878a81c56648 // indirect
