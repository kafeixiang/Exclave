...
The native libraries of a plugin are executables that run in separate processes. Therefore, the native libraries of a plugin are not subject to the restrictions of the GNU General Public License. The license of the upstream project applies to the native libraries of the corresponding plugin.
