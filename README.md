...
The follwing procudure is for typical AMD64 Linux distros only. It is possible to build on other platforms but the arguments may need some modifications.
