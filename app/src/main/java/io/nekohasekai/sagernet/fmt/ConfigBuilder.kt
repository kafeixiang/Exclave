...
fun buildV2RayConfig(
    ...
    V2RayConfig().apply {
        ...
        if (DataStore.enableDnsRouting) {
            getStringValue(DataStore.experimentalFlags, "directDNSDomainList")?.split(",")?.let {
                bypassDomain.addAll(it)
            } ?: {
            ...
            getStringValue(DataStore.experimentalFlags, "remoteDNSDomainList")?.split(",")?.let {
                proxyDomain.addAll(it)
            } ?: {
