    ...
    private suspend fun streamingLog() = onIoDispatcher {
        ...
        try {
            ...
            while (true) {
                ...
                onMainDispatcher {
                    val scrollViewScrollY = binding.logsScrollView.scrollY
                    val atBottom = (scrollViewScrollY + binding.logsScrollView.height) >= binding.logsTextView.height * 0.9
                    ...
                    if (atBottom) {
                        binding.logsScrollView.post {
                            binding.logsScrollView.smoothScrollTo(0, binding.logsTextView.height)
                        }
                    }
                }
            }
