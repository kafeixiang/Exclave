...
fun parseProxies(text: String): List<AbstractBean> {
    ...
    fun String.parseLink(entities: ArrayList<AbstractBean>) {
        ...
        when {
            ...
            startsWith("socks://") || startsWith("socks4://") || startsWith("socks4a://") ||
            ...
            startsWith("vmess://") || startsWith("vless://") || startsWith("trojan://") -> {
            ...
            startsWith("hysteria2://") || startsWith("hy2://") -> {
